...
from .bindings import RaspsimException
from .elf import ELF


def main() -> None:
    parser = argparse.ArgumentParser(description="x86sim simulator")
    ...
    with simcompile(code=program, entry_label=args.entry_label, lang=args.lang, compiler=args.compiler, std=args.std, debug_symbols=True) as f:
        elf = ELF.from_file(f)
